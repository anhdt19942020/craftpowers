...
|-------|-----------|-----------|
| Protocol | `rules/protocol.md` | WebSocket handshake, frames, ping/pong, close codes |
| Scaling | `rules/scaling.md` | Horizontal scaling, Redis pub/sub, sticky sessions |
| Patterns | `rules/patterns.md` | Rooms, namespaces, broadcasting, acknowledgments |
| Security | `rules/security.md` | Authentication, authorization, rate limiting, CORS |
| Alternatives | `rules/alternatives.md` | SSE, long polling, when to choose WebSockets |
| Fastify WebSockets | `rules/fastify-websockets.md` | Fastify-specific WebSocket patterns with @fastify/websocket |
