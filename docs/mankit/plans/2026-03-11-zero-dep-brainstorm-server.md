...
> **For agentic workers:** REQUIRED: Use man:subagent-driven-development (if subagents available) or man:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.
