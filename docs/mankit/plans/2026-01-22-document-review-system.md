...
> **For agentic workers:** REQUIRED: Use man:subagent-driven-development (if subagents available) or man:executing-plans to implement this plan.
...
```markdown
> **For agentic workers:** REQUIRED: Use man:subagent-driven-development (if subagents available) or man:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
